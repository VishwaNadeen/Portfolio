...
export default function GithubLanguages() {
  ...
  return (
    <section className="space-y-4 sm:space-y-5">
      <h2 className="text-lg font-semibold text-white sm:text-xl">Languages</h2>
      ...
      <div className="animate-[fade-up_0.65s_cubic-bezier(.22,.8,.5,1)_forwards] opacity-0">
        <>
          ...
          {!data ? (
            <div className="rounded-2xl border border-white/10 bg-white/[0.05] p-4 shadow-[0_12px_30px_rgba(0,0,0,0.35)] backdrop-blur-md sm:p-6">
              <h3 className="text-sm font-semibold text-white sm:text-lg">GitHub Languages</h3>
            ...
            <div className="rounded-2xl bg-white/[0.05] p-4 shadow-[0_12px_30px_rgba(0,0,0,0.35)] backdrop-blur-md sm:p-6">
              <h3 className="text-sm font-semibold text-white sm:text-lg">GitHub Usage</h3>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center justify-between gap-2 sm:gap-3 text-xs sm:text-sm">
                        ...
                        <span
                          className="ml-2 shrink-0 font-semibold tabular-nums text-[11px] transition-colors duration-200 animate-[pct-pop_0.4s_cubic-bezier(.22,.8,.5,1)_both] sm:ml-4 sm:text-sm"
