    ...
    <main className="min-h-screen bg-slate-950 px-4 py-10">
      <div className="mx-auto max-w-6xl space-y-6">
        <header className="flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-2xl font-semibold text-white">Admin • Projects</h1>
              ...
              <div className="mt-4 space-y-3">
                <label className="block text-xs text-slate-400">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditing((prev) => (prev ? { ...prev, customTitle: e.target.value } : prev))
                    }
                  />
                </label>
                ...
                <label className="block text-xs text-slate-400">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditing((prev) => (prev ? { ...prev, liveUrl: e.target.value } : prev))
                    }
                  />
                </label>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="flex items-end gap-2">
                    <button
                      type="button"
                      onClick={() =>
                        setEditing((prev) => (prev ? { ...prev, featured: !prev.featured } : prev))
                      }
                    ...
                    <button
                      type="button"
                      onClick={() =>
                        setEditing((prev) => (prev ? { ...prev, isHidden: !prev.isHidden } : prev))
                      }
                      className={`w-full rounded-xl px-3 py-2 text-sm font-semibold ${
                        editing.isHidden
                          ? "bg-yellow-500/15 text-yellow-200 border border-yellow-500/30"
